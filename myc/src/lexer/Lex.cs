...
namespace myc
{
    public static class Lex
    {
        ...
        [
            ...
            new("Increment",       @"\+\+",            (name)=>TokensEnum.DoublePlus.ToString()),
            ...
            new("AddEqual",        @"\+=",             (name)=>TokensEnum.PlusEqual.ToString()),
            new("SubtractEqual",   @"-=",              (name)=>TokensEnum.HyphenEqual.ToString()),
            new("MultiplyEqual",   @"\*=",             (name)=>TokensEnum.AsteriskEqual.ToString()),
            new("DivideEqual",     @"/=",              (name)=>TokensEnum.ForwardSlashEqual.ToString()),
            new("RemainderEqual",  @"%=",              (name)=>TokensEnum.PercentEqual.ToString()),
            ...
            new("ANDEqual",        @"\&=",              (name)=>TokensEnum.ANDEqual.ToString()),
            new("OREqual",         @"\|=",              (name)=>TokensEnum.OREqual.ToString()),
            new("XOREqual",        @"\^=",              (name)=>TokensEnum.XOREqual.ToString()),
            new("LeftShiftEqual",  @"\<\<=",            (name)=>TokensEnum.LeftShiftEqual.ToString()),
            new("RightShiftEqual", @"\>\>=",            (name)=>TokensEnum.RightShiftEqual.ToString()),
